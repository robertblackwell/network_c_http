...
int test_make_buffer()
{
    ...
    UT_EQUAL_INT((int)Cbuffer_size(b), 0);
...
int test_expansion()
{
    ...
    UT_EQUAL_INT((int)(5*strlen(extra)), (int)Cbuffer_size(b2));
...
int test_big_expansion()
{
    ...
    printf("b2 m_capacity %ld \n", Cbuffer_capacity(b2));
    printf("b2 m_cptr %lx \n", (long)Cbuffer_data(b2));
    UT_EQUAL_INT((int)(2800*strlen(extra)), (int)Cbuffer_size(b2));
    Cbuffer_free(b2);
    b2 = NULL;
    UT_EQUAL_PTR(b2, NULL);
    free(s1);
...
int test_chain_make()
{
    ...
    UT_EQUAL_LONG((long)BufferChain_size(bcr), (long)2800*strlen(extra))
...
int test_iobuffer_commit_consume_extra()
{
    ...
    long len_1 = IOBuffer_data_len(iob);
    UT_EQUAL_LONG(len_1, strlen(s1));
    ...
    long len_2 = IOBuffer_data_len(iob);
    UT_EQUAL_LONG(len_2, (long)(strlen(s1) + strlen(s2)));
    ...
    UT_EQUAL_INT((int)strlen(s2), (int)IOBuffer_data_len(iob));
