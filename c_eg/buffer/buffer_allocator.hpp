...
/** 
* \ingroup buffers
* Strategy for allocating buffers for message headers
*/
...
/** 
* \ingroup buffers
* Strategy for allocating buffers for message bodies
*/
...
/** 
* \ingroup buffers
* Strategy for allocating buffers for tunnel connectin
*/
