...
static void connection_completion_cb(void* href)
{
    ...
    handler_ref->completion_callback(handler_ref->completion_cb_arg, href);
}
        ...
        void* completion_cb_arg)
{
    ...
    demohandler_init(this, socket, reactor_ref, completion_cb, completion_cb_arg);
    return this;
}
        ...
        void* completion_cb_arg)
{
    ...
    this->completion_cb_arg = completion_cb_arg;
