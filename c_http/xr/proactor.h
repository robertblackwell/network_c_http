...
void Xrsw_start_read(XrSocketWatcherRef sock, void* buffer, int length, SocketEventHandler cb, void* user_data);
void Xrsw_start_write(XrSocketWatcherRef sock, void* buffer, int length, SocketEventHandler cb, void* user_data);
