#ifndef c_http_threadlocal_intrusive_list_h
#define c_http_threadlocal_intrusive_list_h
#include "mblock.h"
struct MBlockList_s;
 ...
 */
MBlock* tl_intrusive_list_find_space(const MBlockList* list, size_t user_space_required);
/**
 ...
 */
void tl_intrusive_list_remove(MBlockList* list, MBlock* block);

/**
 *  Find the block denoted by needle parameter in the list. Return
 *  needle if found NULL if not
 */
void* tl_intrusive_list_find(const MBlockList* list, const MBlock* needle);
#endif