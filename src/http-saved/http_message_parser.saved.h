...
#include <stdint.h>
#define USE_OLD_HTTP_PARSER
#ifdef USE_OLD_HTTP_PARSER
...
struct HttpMessageParser_s {
    ...
    http_parser_t*                  m_http_parser_ptr;
    http_parser_settings_t*         m_http_parser_settings_ptr;
...
http_errno_t          http_message_parser_consume_eof(HttpMessageParser* parser);
