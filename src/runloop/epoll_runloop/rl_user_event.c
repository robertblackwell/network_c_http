...
void runloop_user_event_init(RunloopEventfdRef this, RunloopRef runloop)
{
...
RunloopRef runloop_user_event_get_runloop(RunloopEventfdRef athis)
{
    EVENTFD_SET_TAG(athis);
    EVENTFD_CHECK_TAG(athis)
    return athis->runloop;
}
int runloop_user_event_get_fd(RunloopEventfdRef athis)
{
    EVENTFD_SET_TAG(athis);
    EVENTFD_CHECK_TAG(athis)
    return athis->fd;
...
void runloop_user_event_verify(RunloopEventfdRef athis)
{
    EVENTFD_SET_TAG(athis);
    EVENTFD_CHECK_TAG(athis)
}
