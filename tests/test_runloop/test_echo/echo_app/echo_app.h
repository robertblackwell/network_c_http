 ...
 */
void* generic_echo_app_new(RunloopRef rl, int connection_fd);
void generic_echo_app_free(void* app_ref);
void generic_echo_app_run(void* app_ref, void(cb)(void* app_ref, void* server_ref, int fd), void* arg);
