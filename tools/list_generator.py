...
def c_include(name_parameter, node_parameter, item_parameter):
    text="""
        ...
        #endif
    """
    return text.format(name=name_parameter, node=node_parameter, item=item_parameter)


def c_source(name_parameter, node_parameter, item_parameter):
...
print(c_include("MyList", "MyListNode", "SomeItem"));
print (c_source("MyList", "MyListNode", "SomeItem"));
